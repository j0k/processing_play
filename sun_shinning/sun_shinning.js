...
var img;
function setup() {
  img = loadImage("assets/tusion_logo.png"); 
  ...
  //saveCanvas('myCanvas2', 'jpg');
}

function draw() {
  image(img, width/2 - img.width/10, height/2 -  img.height/10 - 50, img.width/5, img.height/5);
  //return;
...
saveFrames('e:\to_save\out', 'png', 1, 25, function(data) {
  print(data);
});
}
